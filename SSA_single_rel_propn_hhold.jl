...
function initialise_gillespie(params_dict::Dict)
    ...
    @unpack fem_m0, male_m0, fem_w0, male_w0, H, m_free0, w_free0, rho, t_start, t_end, rel_t, rel_prop = params_dict  # unpack the parameter values
    ...
    male_w_vec, fem_w_vec, tOut, rel_t, num_house_vec, key_house_vec, track_fem_m, track_male_m, track_fem_w, track_male_w, track_fem_m_rel, track_male_m_rel, track_fem_w_rel, track_male_w_rel 
    # 
end
...
function gillespie(params_dict::Dict)
    ...
    rel_t, num_house_vec, key_house_vec, track_fem_m, track_male_m, track_fem_w, track_male_w, track_fem_m_rel, 
