...
@time begin
    @sync @distributed for i in 1:num_simulations
        ...
        CSV.write(joinpath(JOB_ID,"fem_m_hholds_$(i)_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_fem_m_hholds)
        CSV.write(joinpath(JOB_ID,"male_m_hholds_$(i)_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_male_m_hholds)
        CSV.write(joinpath(JOB_ID,"fem_w_hholds_$(i)_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_fem_w_hholds)
        CSV.write(joinpath(JOB_ID,"male_w_hholds_$(i)_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_male_w_hholds)
    end
end
...
CSV.write(joinpath(JOB_ID,"m_mosqs_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_m)
CSV.write(joinpath(JOB_ID,"w_mosqs_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_w)
# for total free wildtypes and Wolbachia-infected mosquitoes
CSV.write(joinpath(JOB_ID,"free_m_mosqs_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_free_m)
CSV.write(joinpath(JOB_ID,"free_w_mosqs_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_free_w)
# for tracked household mosquitoes of each type
CSV.write(joinpath(JOB_ID,"track_fem_m_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_track_fem_m)
CSV.write(joinpath(JOB_ID,"track_male_m_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_track_male_m)
CSV.write(joinpath(JOB_ID,"track_fem_w_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_track_fem_w)
CSV.write(joinpath(JOB_ID,"track_male_w_$(alpha_str)_$(gamma_str)_$(rho_str)_$(tau_str)_$(H)__$(rel_t)_$(rel_male)_$(rel_fem)_relhhold.csv"), df_track_male_w)
