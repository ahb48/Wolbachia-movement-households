...
function initialise_gillespie(params_dict::Dict)
    ...
    male_w_vec, fem_w_vec, tOut, rel_t, delta_rel, num_house_vec, key_house_vec, track_fem_m_rel, track_male_m_rel, track_fem_w_rel, track_male_w_rel 
    # track_fem_m, track_male_m, track_fem_w, track_male_w,
end
...
function gillespie(params_dict::Dict)
    ...
    rel_t, delta_rel, num_house_vec, key_house_vec, track_fem_m_rel, 
    ...
    return m_vec, w_vec, free_m_vec, free_w_vec, num_house_vec, key_house_vec, track_fem_m_rel, track_male_m_rel, track_fem_w_rel, track_male_w_rel
    #track_fem_m, track_male_m, track_fem_w, track_male_w,
end
